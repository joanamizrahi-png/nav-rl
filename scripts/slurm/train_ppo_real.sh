...
KNOB_NAMES='LIVE|RW5|RW|RW5SMOOTH|SMOOTHCOST|SEED|TARGETKL|STEPS|STEPS_OVERRIDE|PROBE|MAXSTEPS|GOALSUPPORT|GOAL360|NOGATE|TIMEOUTDIST|SEMW|SEMPAL|LIVEBATCH|LIVEFRAMES|ROTATE|GOALRANGE|GOALCONE|GOALNOISE|GOALXY|GOALDIST|GOALDIST_START|GOALDISTWIN|GOALFRAMERANGE|SPAWNCLS|SPAWNJYAW|SPAWNJLAT|SPAWNMIN|SPAWNMAX|HEIGHT|WIDTH|RENDERH|RENDERW|REWSCALE|TRAV|SCENES|SCENE|NSC|LIVECKPT|COH|COHTAU|COHTERM|COLLAHEAD|BOXMEM|RASTEROBS|STATICSCENE|COLLTERM|CURRICULUM|WARMSTART|CRASHPEN|HALT|HALTEPS|HALTSCALE|REFUSAL|REFUSALDIST|REFUSALVERGE|VERGECUR|HALTWRONG|HALTWRONGRAMP|NTGOAL|GOALSTOP|STOPACT|VERGEPROG|DWELLCUR|CKPTFREQ|SPEEDCOST|REWSRC|MAPINFL|MAPINFLCLS|HALTCUR|HALTGATE|GOALMIX|GOALMIXMAP|GOALNTTRIES|GOALNTCONE|SPAWNSUPPORT|ENT|CHUNK|PROX|PROXGND|PROXGNDM|GATETAU|TAG|LABEL|CLIPS_DIR|OBSCACHE'
