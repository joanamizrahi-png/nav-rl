...
[ -n "${GOALTURN:-}" ] && LABEL="${LABEL}-turn${GOALTURN}m${GOALTURNMIX:-0.5}"
...
if [ -n "${GOALTURN:-}" ]; then
    BC_ARGS="$BC_ARGS --goal_turn_deg ${GOALTURN} --goal_turn_mix ${GOALTURNMIX:-0.5}"
    OUT="${OUT}_turn${GOALTURN}m${GOALTURNMIX:-0.5}"
fi
