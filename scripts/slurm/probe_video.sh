...
#SBATCH --output=/scratch/m000204-pm06b/joana/slurm-wm-probe-vid-%j.out
#SBATCH --error=/scratch/m000204-pm06b/joana/slurm-wm-probe-vid-%j.err
set -euo pipefail
